...
interface MostCommentedChapter {
  id: string;
  title: string;
  content: string;
  author_username: string;
...
type MostCommentedContent = MostCommentedStory | MostCommentedChapter;

interface MostCommentedListProps {
  contentList: MostCommentedContent[];
}
            ...
            <div className="flex justify-between text-sm text-gray-600 mt-1 mb-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="flex items-center bg-gray-100 px-2 py-0.5 rounded-full">
                  <MessageSquare size={14} className="mr-1 text-[#484DB5]" />
          ...
          >
            ...
            <div className="flex items-center text-sm text-gray-600 mt-1 mb-2">
              <span className="mr-2">
                ...
                <span className="inline-flex items-center bg-[#484DB5]/10 text-[#484DB5] px-2 py-0.5 rounded-md">
