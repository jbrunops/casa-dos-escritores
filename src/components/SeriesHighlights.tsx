        ...
        <section className="py-8">
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-3xl font-extrabold text-black relative">
                    Séries em Destaque
                    <span className="block h-1 w-64 mt-2 bg-gradient-to-r from-primary to-border rounded-full animate-pulse"></span>
                </h2>
                <Link href="/series" className="flex items-center text-primary hover:underline">
                    <span>Ver Todas</span>
                    ...
                    >
                        ...
                        <div className="p-3 flex-grow flex flex-col">
                            ...
                            <div className="mt-auto flex items-center justify-between text-xs text-gray-600">
                                ...
                                <span className="text-xs text-primary bg-primary-100 px-2 py-0.5 rounded">
