                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[1.875rem]">
                    ...
                    {categoriesData.map((category) => (
                        <Link
                            ...
                            className={`block p-6 bg-white rounded-lg shadow-sm border border-border transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:border-primary relative overflow-hidden group`}
                        >
